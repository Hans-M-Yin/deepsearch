...
paths.  It reconstructs the persisted ``PathCandidate`` records from a source
VQA directory and runs only question writing, difficulty enhancement, and
verification for each path.
"""
...
from .schemas import PathCandidate, TrajectoryStats, VqaSample
...
def main(argv: list[str] | None = None) -> int:
    ...
    metadata = {
        ...
        "run": {"status": "running", "resume": not args.no_resume, "workers": args.workers},
    }
