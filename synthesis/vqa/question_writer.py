...
Goal: You should use the provided reasoning_chain to analyze which entities and clues would allow a strong model to infer an entity directly—potentially even the final answer—without traversing the earlier hops, or which descriptive pieces of knowledge in the question are only weakly related to the core reasoning chain, and then eliminate exactly those shortcuts. Keep the question fluent, natural, and benchmark-like.
