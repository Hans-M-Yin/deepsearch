...
OPENSERP_MAX_REQUEST_LIMIT="${OPENSERP_MAX_REQUEST_LIMIT:-5}"
...
OPENSERP_LOG="${OPENSERP_LOG:-${HOME}/openserp_log}"
SERPER_ADAPTER_LOG="${SERPER_ADAPTER_LOG:-${HOME}/serper_openserp_adapter_log}"
...
start_adapter() {
  ...
  (
    ...
    nohup env \
      ...
      OPENSERP_MAX_REQUEST_LIMIT="${OPENSERP_MAX_REQUEST_LIMIT}" \
